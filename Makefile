...
LIB_C := h3.c h3_checkpoint.c h3_host.c h3_safetensors.c h3_weights.c h3_text_encoder.c \
...
h3_vsa_attention_bench: tests/bench_vsa_attention.o $(LIB_OBJ)
	$(CC) -o $@ $^ $(LDLIBS)
